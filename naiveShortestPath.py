...
def explore(levelGrid, currentPos, target, currentSteps = 1, excludeDirection = (None, None)):
    #print(currentSteps)
    minSteps = math.inf
    targetFound = False
...
levelGrid = convertLevelFileToGrid(level, False)
